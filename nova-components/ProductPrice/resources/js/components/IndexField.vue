    ...
    <div class="flex">
        <div class="w-1/2">
            <div class="flex items-center">
                ...
                <span class="font-bold">{{ priceBase | numberFormat }} ₸</span>
            </div>
            <div class="flex items-center">
                <span class="mr-2">Маржа:</span>
                <span class="font-bold">{{ margin }} ₸</span>
            </div>
        ...
        <div class="w-1/2">
            <div class="flex items-center">
                ...
                <span class="font-bold" v-if="!isEditingPriceCost">{{ priceCost | numberFormat }} ₸</span>
            ...
            <div class="flex items-center">
                ...
                <span class="font-bold" v-if="!isEditing">{{ priceMin | numberFormat }} ₸</span>
